...
<head>
  ...
  <link rel="stylesheet" href="/recruit/lib/css/structure.css?ver=<?php echo $version; ?>">
  <?php
  ...
  <?php if (is_front_page()) : ?>
    ...
    <link rel="stylesheet" href="/recruit/lib/css/top.css?ver=<?php echo $version; ?>">
  <?php else : ?>
    <?php
    ...
    ?>
        <link rel="stylesheet" href="/recruit/lib/css/<?php echo $lower_slug ?>.css?ver=<?php echo $version; ?>">
      <?php endif; ?>
    <?php endif; ?>
  <?php endif; ?>
  <!-- end unique css -->
  ...
  $og_image_default = $domain . '/recruit/lib/img/ogp.webp';
...
<body>
  <div id="pageContainer">
    ...
    <header>
      <div id="header">
        <div class="logo"><a href="/recruit/"><img src="/recruit/lib/img/cmn/header_logo.webp" alt="オカノ薬局 採用サイト"></a>
        </div>
        <ul class="gnav">
    ...
    <section id="modal_store" class="modal_box">
      <h2><img src="/recruit/lib/img/cmn/header_logo.webp" alt="オカノ薬局"></h2>
      <div class="modal_close"><span></span><span></span></div>
      <div class="storelist_list">
        <!--  js.clone from footer -->
      </div>
    </section>
